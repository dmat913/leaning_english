...
const DMATButton = ({
  ...
  return (
    ...
    >
      ...
      <span
        className={`inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg  px-3 py-1 text-sm font-medium text-white bg-[#0D0D0D] gap-2 z-[2] ${otherClasses}`}
      >
        {title}
        <FaLocationArrow />
      </span>
